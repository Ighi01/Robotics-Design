 ...
 *
 *      Example of input: 0 2 0 2 90 0 90 0 5 100 3 60 0 30 -> This command cause 2 servo to move simultaneously: the Servo no 0 to move to 90 degrees immediatelly (since 0 delay) at 90 deg/sec velocity and then after 5 seconds 
