    ...
    def run(self):
        ...
        if self.isFirst:
            if self.fsm.ir_sensor1_counter == 0 and self.fsm.ir_sensor2_counter == 0:
                ...
                stepper_movements = {
                                        0: (self.fsm.ir_sensor1.counter / (self.fsm.ir_sensor1.counter + self.fsm.ir_sensor2.counter), 100, 3, 200),
                                        1: (self.fsm.ir_sensor2.counter / (self.fsm.ir_sensor1.counter + self.fsm.ir_sensor2.counter), 100, 3, 200)
                                    }
