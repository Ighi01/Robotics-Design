...
def main():
    state_machine = StateMachine(IR_SENSOR1_PIN, IR_SENSOR2_PIN, PROXIMITY_TRIGGER_PIN, PROXIMITY_ECHO_PIN, LEFT_SCREEN_PINS, RIGHT_SCREEN_PINS, SERVO_CONTROLLER, STEPPER_CONTROLLER, AUDIO_PIN)
    state_machine.run()
